...
| `check:unified-auth-flow` | 小程序统一登录状态机：微信、微信手机号、游客三入口；短信分支保留但当前 UI 不可达；登录直达与可选资料编辑 |
...
- 微信或微信手机号验证成功后必须立即形成持久注册账号并进入登录态功能；缺少昵称或头像不得阻塞使用，头像和昵称作为可选资料可稍后编辑或取消；游客不计入注册账号；
