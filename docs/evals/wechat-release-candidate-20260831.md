...
**游客身份边界候选已于 2026-09-03 完成本地发布门；尚未部署生产，微信审核尚未提交。**

当前候选 `f66e0bddcdf86d8295323f55fb9a24b6751a6b4f` 的 21 个数据库迁移、完整发布门和生产构建均已通过。公开登录范围为微信登录、微信绑定手机号码登录和游客模式，短信入口暂缓。生产仍运行较早的封存版本；此前生产 Smoke、真实 Qwen 合成聊天和旧二维码不得外推为当前候选证据。
