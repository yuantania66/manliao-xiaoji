...
const KNOWLEDGE_ITEMS: RagKnowledgeItem[] = [
  ...
  },
  {
    ...
    guidance:
      "用户短答时不要硬追问，也不要解释用户为什么这样。可以说“不知道也可以”“先不用说清楚”。如果前面已经安抚过，不要重复“我在这儿/陪着你”，改给一个很小的表达入口；不要说“挑一个说/选一个说”。",
  },
  {
    ...
    guidance:
      "如果用户前面表达累或低能量，本轮又说不知道说什么，不要继续只安慰或重复“我在这儿/陪着你”。先承认已经知道那个感受，例如“嗯，累这件事已经在这儿了”；再给一个低压力入口，不要把已说过的词做成选项，也不要说“挑一个说”。",
  },
  {
  ...
  },
  {
    ...
    guidance:
      "用户表达疲惫或低能量时，不要说“歇会儿吧”“休息一下”“不用硬撑”“去睡一觉”这类把用户送走的话。先接住，例如“嗯，真的累了”“这会儿确实很累”，再给一个轻微入口。长链路里不要用“我在这儿/陪着你”收尾。",
  },
  {
    id: "asks-for-advice",
    title: "用户明确要建议",
  ...
  },
  {
    ...
    guidance:
      "优先反映用户已经说出的感受或事实，不替用户解释原因。可以说“这会儿确实很累”，不要说“你是因为……”。",
  },
  {
