...
const EXPRESSION_DIFFICULTY_PATTERN =
  /不知道(说什么|想说什么|怎么说|怎么讲|从哪说|从哪里说|从哪开始|从哪里开始|该不该说|要不要说)|不知(从哪说|从哪里说|从哪开始|从哪里开始)|说不出来|讲不出来|开不了口|不知道怎么开口|想说但说不出来|想说又不想说|卡住了|脑子.*乱|脑袋.*乱/;

const EXPLICIT_ADVICE_REQUEST_PATTERN =
  /给我.*建议|给点建议|一些建议|有.*建议|需要.*建议|帮我.*(想|看看|处理|解决|判断|决定|理一下)|怎么办|怎么做|怎么开口|如何开口|开口.*比较好|该怎么|我该|先做什么|该先做什么|能做什么|下一步|第一步|能不能.*建议|可以.*建议/;
...
const buildClinicalSignals = ({
  ...
  return {
    ...
    explicitAdviceRequest: EXPLICIT_ADVICE_REQUEST_PATTERN.test(text),
