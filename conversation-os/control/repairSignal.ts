...
const USER_CORRECTION_PATTERN =
  /你是不是.*(没懂|没理解)|你.*(没懂|没理解|理解错|理解偏|误会|误解|说错)|你怎么(?:这么|那么)?(?:冷漠|敷衍)|你(?:是不是|感觉)?(?:在)?敷衍|没看出来你(?:有多)?认真|看不出来你(?:有多)?认真|^不对[。！？!?]?$|^(其实)?不是(这个意思|这意思|这样的|这样|那个|因为这个)|不是我想表达的|我(?:刚刚|刚才)?(?:说|问|表达|指)的不是|我不是在说这个|我想纠正一下|我来纠正一下|我纠正一下|我(刚刚|刚才)?是不是没表达清楚/u;
